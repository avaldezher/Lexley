document.write(`
<!-- Modal -->
                <div class="modal fade" id="contratosModal" tabindex="-1" role="dialog">
                  <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><img src="../Lexley/Inicial/Grupo%201421.png" class="mr-2" style="width: 20%;">Nuevo Contrato</h4>
